...
function getOrCreateDetailPanel() {
  ...
  if (detailPanel.length === 0) {
    detailPanel = $('<div id="detail-panel" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); background-color: white; padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); z-index: 1000; width: 60%; max-height: 90%; overflow: auto; display: none;"></div>');
